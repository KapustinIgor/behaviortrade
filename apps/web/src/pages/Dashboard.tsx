...
import { LayoutGrid, Clock, BarChart2, Network } from "lucide-react";
...
export function Dashboard() {
  ...
  const center = (
    <div className="space-y-3">
      {/* Tab bar */}
      <div className="flex items-center gap-1 border-b border-surface-700 pb-2">
        {TABS.map((t) => (
          <button
            key={t.key}
            onClick={() => {
        ...
        <button
          ...
          className="ml-auto flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm text-gray-400 hover:text-gray-200 hover:bg-surface-700 transition-colors"
        >
